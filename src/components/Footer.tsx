    ...
    <footer className="relative bg-[#0a0a0f] border-t border-white/[0.06]">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-20">
        ...
        <div className="py-16 lg:py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          {/* Navigation */}
          <div>
            <p className="text-white/60 text-xs font-semibold uppercase tracking-[3px] mb-6">
              Навигация
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <span className="text-white/50 text-xs uppercase tracking-wider block mb-1">Телефон</span>
                <a
              ...
              <div>
                <span className="text-white/50 text-xs uppercase tracking-wider block mb-1">Email</span>
                <a
            ...
            <div className="flex gap-3 mb-8">
              {socials.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-11 h-11 rounded-xl bg-white/[0.06] border border-white/[0.08] flex items-center justify-center text-white/60 text-xs font-semibold hover:bg-white/[0.1] hover:border-[rgba(245,209,0,0.3)] hover:text-[#f5d100] transition-all duration-300"
                >
                  {s.icon}
                </a>
              ))}
